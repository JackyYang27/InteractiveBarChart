...
//遇到NA就設定為undefined 要不然維持原本的字串
const parseNA = string => (string === 'NA' ? undefined : string);
//字串處理 string轉乘data object
...
update(barChartData);
    ...
    function mouseover(e){ //tip的位置
        ...
        //    tip.select('img').attr('src',`https://image.tmdb.org/t/p/w185/${thisBarData.poster_path}`);
